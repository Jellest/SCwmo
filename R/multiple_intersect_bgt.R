multiple_intersect_bgt <- function(aws.df = AWS.df, aws_list, sensor_name, addition = "", criteria_columnName = "Criteria_Value", exportCSV = FALSE, exportShp = FALSE){
...
multiple_intersect_bgt(aws_list = c("De "), sensor_name = temperature_sensor_name, exportCSV = TRUE, exportShp = FALSE)
